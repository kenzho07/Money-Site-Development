...
namespace Drupal\ms_csv_importer\Plugin;
...
class ImporterManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/Importer', $namespaces, $module_handler, 'Drupal\ms_csv_importer\Plugin\ImporterInterface', 'Drupal\ms_csv_importer\Annotation\Importer');
